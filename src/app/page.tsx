...
import { Award, Car, Droplets, Package, Sparkles } from "lucide-react";
      ...
      plans={[
        {
          ...
          price: "$99",
          period: "starting at",
          description: "Ideal for a spotless and sanitized cabin.",
          button: {
            text: "Book Interior",
            href: "#contact",
          },
        ...
        },
        {
          ...
          price: "$159",
          period: "starting at",
          description: "The ultimate full vehicle transformation.",
          button: {
        ...
        },
        {
          ...
          price: "$100",
          period: "per pair",
          description: "Restore clarity and save on replacement costs.",
          button: {
          ...
          features: [
            ...
            "Significant savings vs. new headlights",
          ],
        },
      ]}
